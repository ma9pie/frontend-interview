export const frontend = [
  ...
  },
  {
   ...
   위의 링크에서 index.html의 위치를 표기한 https://www.example.com/index.html 까지는 URL입니다.
  ...
  },
  {
    ...
    HTML을 클라이언트에 보내기 전에 서버 측에서 웹 애플리케이션을 렌더링 하는 것을 의미합니다. 서버는 클라이언트에게 요청을 받으면 미리 렌더링 된 페이지를 제공하고, 이러한 방식은 페이지가 처음 로드될 때 컨텐츠가 검색 엔진에 표시되므로 더 빠른 초기 로드 시관과 더 나은 SEO(검색 엔진 최적화)를 제공합니다.`,
  },
  {
    importance: "5",
  ...
  },
  {
    ...
    answer: `이벤트 루프는 콜 스택과 태스크 큐를 주시하고 콜 스택이 비어있다면 테스트 큐에 있던 작업을 콜 스택으로 보내주는 역할을 합니다.`,
  },
  {
    importance: "5",
    ...
    2. View : 뷰는 데이터를 렌더링 하고 사용자에게 표시 및 상호작용할 수 있는 인터페이스를 만드는 역할을 합니다.
    ...
    1. Model : 모델은 MVC패턴과 마찬가지로 애플리케이션의 데이터와 로직을 나타냅니다.
    2. View : 뷰는 MVC패턴과 같이 데이터를 렌더링 하고 사용자에게 표시하는 역할을 합니다.
