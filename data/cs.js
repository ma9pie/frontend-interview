const list = [
  {
    ...
    answer: `객체지향프로그래밍(OOP, Object Oriented Programming)은 컴퓨터 프로그래밍 패러다임 중 하나로, 데이터를 추상화시켜 상태(attribute)와 행위(Method)를 가진 객체로 만들고 그 객체들 간의 상호작용을 통해 로직을 구성하는 프로그래밍 방법입니다.
  ...
  {
    importance: "5",
    question: "프로세스와 스레드의 차이에 대해 설명해 주세요.",
  ...
  {
    importance: "5",
    question: "멀티 프로세스와 멀티 스레드의 차이에 대해 설명해 주세요.",
    answer: `Multi-Process : 하나의 프로그램을 여러 개의 프로세스로 구성하여 각 프로세스가 하나의 작업(task)을 처리하는 것
  ...
  {
    importance: "5",
    question: "Stack과 Queue의 차이에 대해 설명해 주세요.",
    answer: `[Stack]
  ...
  {
    importance: "5",
    question: "List, Map, Set의 차이점을 설명해 주세요.",
    answer: `[List]
    - 순서와 중복이 있는 자료구조
    - 인덱스로 원소에 접근이 가능
    - 크기가 가변적
  ...
  {
    importance: "5",
    question: "라이브러리와 프레임워크의 차이점을 설명해 주세요.",
